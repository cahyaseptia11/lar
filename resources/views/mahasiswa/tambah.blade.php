    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mt-5">
                ...
                <a class="nav-link" style="float:left;">{{ __('Tambah Data') }}</a>
                ...
                <div class="card-body">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nim" type="text" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ old('nim') }}" required autocomplete="name" autofocus>                               
                                @error('nim')
                                <span>{{ $message }}</span>
                                @enderror
                            </div>                          
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="alamat" type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ old('alamat') }}"required autocomplete="new-alamat">
                                @error('alamat')
                                <span>{{ $message }}</span>
                                @enderror
                            </div>
